package calebjones.me.spacelaunchnow.content.loader;
...
import calebjones.me.spacelaunchnow.content.models.Location;
import calebjones.me.spacelaunchnow.content.models.Mission;
import calebjones.me.spacelaunchnow.content.models.LocationAgency;
import calebjones.me.spacelaunchnow.content.models.Pad;
import calebjones.me.spacelaunchnow.content.models.Rocket;
import calebjones.me.spacelaunchnow.content.models.RocketAgency;

/**
 * Class that parses the next 10 upcoming launches.
 */
public class LaunchLoader extends AsyncTask<String, Void, List<Launch>>{
    ...
    public void parseResult(String result) throws JSONException {
        try {
            ...
            if (null == launchArrayList) {
                launchArrayList = new ArrayList<Launch>();
            }
            ...
            for (int i = 0; i < launchesArray.length(); i++) {
                ...
                Log.d(LaunchApplication.TAG, "Launch " + i + ": " + launch.getName());
                ...
                if (rocketObj != null){
                    ...
                    Log.d(LaunchApplication.TAG, "Launch " + i + ": Rocket  - " + rocket.getName());
                    ...
                    if (agencies != null){
                        ...
                        for (int a = 0; a < agencies.length(); a++){
                            ...
                            Log.d(LaunchApplication.TAG, "Launch " + i + ": Rocket Agency - " + rocketAgency.getName());
                ...
                if (locationObj != null){
                    ...
                    if (pads != null){
                        ...
                        for (int a = 0; a < pads.length(); a++){
                            ...
                            Log.d(LaunchApplication.TAG, "Launch " + i + ": Location  - " + location.getName());
                            ...
                            Log.d(LaunchApplication.TAG, "Launch " + i + ": Pad - " + locationPads.getName());
                            ...
                            if (padAgencies != null){
                                ...
                                for (int b = 0; b < padAgencies.length(); b++){
                                    JSONObject padAgenciesObj = launchesArray.optJSONObject(b);
                                    ...
                                    Log.d(LaunchApplication.TAG, "Launch " + i + ": Pad Agency - " + locationPads.getName());
                ...
                if (missions != null) {
                    ...
                    for (int c = 0; c < missions.length(); c++){
                        ...
                        Log.d(LaunchApplication.TAG, "Launch " + i + ": Mission  - " + missionList.get(c).getDescription());
                    }
