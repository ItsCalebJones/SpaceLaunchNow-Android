                ...
                if (rocketObj != null){
                    ...
                    if (agencies != null){
                        ...
                        for (int a = 0; a < agencies.length(); a++){
                            ...
                            Log.d(LaunchApplication.TAG + "Prev", "Launch " + i + ": Rocket Agency - " + rocketAgency.getName());
                ...
                if (locationObj != null){
                    ...
                    if (pads != null){
                        ...
                        for (int a = 0; a < pads.length(); a++){
                            ...
                            Log.d(LaunchApplication.TAG + "Prev", "Launch " + i + ": Location  - " + location.getName());
                            ...
                            Log.d(LaunchApplication.TAG + "Prev", "Launch " + i + ": Pad - " + locationPads.getName());
                            ...
                            if (padAgencies != null){
                                ...
                                for (int b = 0; b < padAgencies.length(); b++){
                                    ...
                                    Log.d(LaunchApplication.TAG + "Prev", "Launch " + i + ": Pad Agency - " + locationPads.getName());
