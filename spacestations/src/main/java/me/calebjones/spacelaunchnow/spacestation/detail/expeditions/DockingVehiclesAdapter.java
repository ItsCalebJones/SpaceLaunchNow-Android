 ...
 */
public class DockingVehiclesAdapter extends RecyclerView.Adapter<DockingVehiclesAdapter.ViewHolder> {
    public int position;
    private RealmList<Sp> launchList;
    ...
    public DockingVehiclesAdapter(Context context, boolean night) {
