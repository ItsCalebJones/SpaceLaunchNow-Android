...
public class VideoListItem {
    ...
    private VideoListItem(Builder builder) {
    ...
    public static class Builder {
        ...
        protected CharSequence videoURL;
        protected long id;
        ...
        public Builder videoURL(@StringRes int videoURLRes) {
            return videoURL(context.getString(videoURLRes));
        }

        public Builder videoURL(CharSequence videoURL) {
        ...
        public VideoListItem build() {
            return new VideoListItem(this);
        }
    }
