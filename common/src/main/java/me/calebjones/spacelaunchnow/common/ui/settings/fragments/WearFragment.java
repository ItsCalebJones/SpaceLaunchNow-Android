...
public class WearFragment extends BaseSettingFragment implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setUpPreferences() {
        ...
        blurSettings.setOnPreferenceClickListener(preference -> {
            ...
            final AppCompatSeekBar blurSeekBar = dialog.getCustomView().findViewById(R.id.blur_seekbar);
            final AppCompatSeekBar radiusSeekBar = dialog.getCustomView().findViewById(R.id.radius_seekbar);
            final AppCompatSeekBar dimSeekBar = dialog.getCustomView().findViewById(R.id.dim_seekbar);
            final AppCompatSeekBar greySeekBar = dialog.getCustomView().findViewById(R.id.grey_seekbar);
