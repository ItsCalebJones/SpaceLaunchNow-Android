...
public class CustomTabActivityHelper {
    ...
    public void unbindCustomTabsService(Activity activity) {
        Timber.v("Unbinding CustomTabService");
    ...
    public CustomTabsSession getSession() {
        if (mClient == null) {
            Timber.v("getSession CustomTabsSession - mClient null");
            mCustomTabsSession = null;
        } else if (mCustomTabsSession == null) {
            Timber.v("getSession CustomTabsSession - mCustomTabsSession null");
            mCustomTabsSession = mClient.newSession(null);
        }
        Timber.v("getSession CustomTabsSession - returning CustomTabSession");
