...
public class QueryBuilder {
    ...
    private static RealmQuery<LaunchRealm> filterVehicle(RealmQuery<LaunchRealm> query,
                                                         ArrayList<String> vehicleFilter) {
    ...
    private static RealmQuery<LaunchRealm> filterLocation(RealmQuery<LaunchRealm> query,
                                                          ArrayList<String> locationFilter) {
        boolean firstGroup = true;
    ...
    private static RealmQuery<LaunchRealm> filterAgency(RealmQuery<LaunchRealm> query,
                                                        ArrayList<String> agencyFilter) {
        boolean firstGroup = true;
    ...
    private static RealmQuery<LaunchRealm> filterCountry(RealmQuery<LaunchRealm> query,
                                                         ArrayList<String> countryFilter) {
        boolean firstGroup = true;
