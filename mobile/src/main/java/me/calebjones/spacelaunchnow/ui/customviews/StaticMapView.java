package me.calebjones.spacelaunchnow.ui.customviews;
...
public class StaticMapView extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.StaticMapView, defStyle, 0);
        mAspectRatio = a.getFloat(R.styleable.StaticMapView_aspectRatio, 0);
        a.recycle();
    }
